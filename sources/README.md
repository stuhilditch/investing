...
Copy only when Stu confirms. Originals are in `~/Moncel/Assistant/archive/misc/Inbox/LEGAL/` unless
noted.

| Document | Date | Where it is |
|---|---|---|
| Supplemental Deed — GHS Hilditch Trust (fully executed) | 2026-05-08 | `~/Moncel/Assistant/archive/misc/Inbox/LEGAL/EXECUTED/` |
| Supplemental Deed — Ellell Trust (fully executed) | 2026-05-08 | `~/Moncel/Assistant/archive/misc/Inbox/LEGAL/EXECUTED/` |
| Single Director's Declarations, both trustee resolutions (fully executed) | 2026-05-08 | `~/Moncel/Assistant/archive/misc/Inbox/LEGAL/EXECUTED/` |
| Australia Director Agreement — GHS Hilditch Mgmt (fully executed) | 2026-05-08 | `~/Moncel/Assistant/archive/misc/Inbox/LEGAL/EXECUTED/` |
| Deed of Indemnity (fully executed) | 2026-05-08 | `~/Moncel/Assistant/archive/misc/Inbox/LEGAL/EXECUTED/` |
| Acquisition of Company — GHS Ellell Management Pty Ltd (parts 1 and 2, signed) | 2026-05 | `~/Moncel/Assistant/archive/misc/Inbox/LEGAL/EXECUTED/` |
