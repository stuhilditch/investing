...
description: Use whenever a decision about where Stu and Danni's own money sits or moves is in play: opening or comparing a broker, platform, account, ISA, SIPP, pension, offshore bond, savings account or fund; buying, holding, topping up, timing or rebalancing an actual holding; parking cash in GBP or AUD; company contributions from Moncel UK; or weighing a proposal, adviser note or friend's tip that something is tax-efficient. They are UK resident under the 4-year FIG regime with Australian trusts, so UK tax, situs, HMRC reporting-fund status and adviser routing get checked before money lands anywhere — including quick, casual or "just while we decide" questions, and before any generic portfolio, allocation or harvesting skill applies US concepts (IRA, 401k, Roth, wash sale) to this household. Not for market history or return statistics, business bookkeeping and software choices, or document, template and repo tasks.
---
